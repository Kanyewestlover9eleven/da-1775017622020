...
const basePath = '/da-1775017622020';
...
export default function Home() {
  ...
  const products = [{ n: 'da', d: 'da', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+1', icon: 'domain' }, { n: 'da', d: 'da', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+2', icon: 'architecture' }, { n: 'da', d: 'da', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+3', icon: 'chair' }, { n: 'da', d: 'da', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+4', icon: 'eco' }, { n: 'da', d: 'da', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+5', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">da</span>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              da <span className="text-accent">Excellence.</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              da delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/`}
              target="_blank"
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">da</p>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Integrityda</h4>
                  <p className="text-sm text-on-surface-variant">da</p>
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-12">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm leading-relaxed">da</p>
                  </div>
                </div>
                <div className="flex gap-6">
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">da</div>
            <p className="text-white/60 text-sm leading-relaxed">da</p>
          </div>
          ...
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              &copy; {new Date().getFullYear()} da. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
